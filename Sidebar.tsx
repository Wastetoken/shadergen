...
const Sidebar: React.FC<SidebarProps> = ({ 
  ...
  return (
    <div className="w-80 h-screen bg-neutral-900/98 backdrop-blur-3xl border-r border-white/5 flex flex-col shadow-2xl overflow-hidden">
      ...
      <div className="p-4 border-t border-white/5 flex flex-col gap-4 bg-neutral-950/20 shrink-0">
        <button 
          onClick={onExport}
          className="w-full py-3 bg-white text-black rounded-xl text-[10px] font-black uppercase tracking-[0.2em] hover:bg-cyan-400 transition-colors flex items-center justify-center gap-2"
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><path d="M16 4h4v4"/><path d="M12 12 20 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h7"/></svg>
          Export React Code
        </button>
        <p className="text-[9px] text-neutral-400 font-mono text-center leading-tight uppercase tracking-[0.2em] opacity-40">
          GPU ACCELERATED // v2.6.0
        </p>
      </div>
    </div>
  );
